      ...
      <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl">
        <div className="mb-6 text-center">
          ...
          <p className="mt-2 text-sm text-gray-500">
            Sign in with your account. Your request will be reviewed by an admin.
          </p>
        </div>

        <div className="rounded-lg bg-blue-50 p-4 text-sm text-blue-800 mb-6">
          <strong>How it works:</strong>
          <ol className="mt-2 list-decimal list-inside space-y-1">
            <li>Sign in with Google or GitHub</li>
            <li>Your request goes to the admin queue</li>
            <li>Admin approves your account</li>
            <li>Link your Telegram to receive weather alerts</li>
          </ol>
        </div>
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-800 bg-gray-900 px-4 py-3 font-medium text-white shadow-sm transition hover:bg-gray-800"
          >
